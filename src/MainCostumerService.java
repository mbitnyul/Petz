...
public class MainCostumerService extends javax.swing.JFrame {
    ...
    public void getData(){
        DB DB = new DB();
        String[] jTableColumn = {"id", "name_tag", "keterangan", "status"};
        String query = "SELECT "
                    + "A.id, "
                    + "A.name_tag, "
                    + "A.keterangan, "
                    + "B.status "
                + "FROM hewan A INNER JOIN status_hewan B "
                    + "ON A.status = B.id_status";
        DB.DataGetQuery(jTable1, jTableColumn, query);
    }
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(244, 191, 33), 3), "Tambah Data Hewan Baru", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(255, 255, 255))); // NOI18N
